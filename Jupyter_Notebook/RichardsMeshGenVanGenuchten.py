...
'''
def showParameters(thetaS,thetaR,Ks,n,alpha,alphaSpecificStorage,betaSpecificStorage,et,eta,labelSize,titleSize,axisTicksSize,lineWidth):
    hover = HoverTool(tooltips=[
    ("(x,y)", "($x, $y)"),
    ])
...
'''
def writeGridNetCDF(eta,etaDual,z,zDual,spaceDelta,deltaZ,psiIC,thetaS,thetaR,Ks,n,alpha,alphaSpecificStorage,betaSpecificStorage,et,outputFileName,outputTitle,outputInstitution,outputSummary,folderPath,outputDate,inputFileName):
